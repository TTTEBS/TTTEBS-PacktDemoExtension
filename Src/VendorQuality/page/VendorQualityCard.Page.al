page 50104 "TTTEBS Vendor Quality Card"
{
    PageType = Card;
    ApplicationArea = All;
    UsageCategory = Administration;
    SourceTable = "TTTEBS VendorQuality";
    ...
    var
        VendorQualityMgt: Codeunit "TTTEBS VendorQualityMgt";
    begin
        VendorQualityMgt.UpdateVendorQualityStatistic(Rec);
    end;
